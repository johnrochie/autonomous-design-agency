-- Autonomous Design Agency - Complete Activation Script
-- Run this ENTIRE script in Supabase SQL Editor
-- Creates all tables, policies, functions, and seed data

-- =====================================================
-- PART 1: AGENT SYSTEM
-- =====================================================

-- AGENT TASKS TABLE (CREATE FIRST TO AVOID CIRCULAR REFERENCE)
...
-- =====================================================
-- PART 5: TREND RESEARCH
-- =====================================================

ALTER TABLE public.content_topics ADD COLUMN IF NOT EXISTS trend_score REAL DEFAULT 0;
ALTER TABLE public.content_topics ADD COLUMN IF NOT EXISTS trend_sources TEXT[] DEFAULT '{}';
ALTER TABLE public.content_topics ADD COLUMN IF NOT EXISTS last_researched TIMESTAMP WITH TIME ZONE;
ALTER TABLE public.content_topics ADD COLUMN IF NOT EXISTS research_notes TEXT;
...
SELECT '  - Social Media: 4' as result;
SELECT '  - Email: 1' as result;
SELECT '  - Cron Jobs: 2' as result;
SELECT '  - Trend Research: 3' as result;
SELECT '' as result;
...
SELECT '  1. Setup SendGrid API key (optional)' as result;
SELECT '  2. Add social media API keys (optional)' as result;
SELECT '  3. Test at /api/cron/status' as result;
SELECT '  4. View analytics at /admin/analytics' as result;
SELECT '====================================' as result;
